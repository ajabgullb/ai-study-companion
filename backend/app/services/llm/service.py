...
import logging
from typing import (
  Any, Callable, List, Optional, Type, TypeVar, Union, overload
)

from langchain_core.language_models import LanguageModelInput
from langchain_core.messages import BaseMessage
from openai import (
  APIError, APITimeoutError, OpenAIError, RateLimitError
)
    ...
    **model_kwargs: Any,
    ...
    Args:
      ...
      **model_kwargs: Extra kwargs forwarded to ``LLMRegistry.get`` 
      (e.g. ``temperature``, ``max_tokens``, ``reasoning``).
